<?php
include 'config.php'; // Include config.php to access the $pdo connection
...
<body>
    ...
    <main class="auth-container">
        <div class="auth-card">
            ...
            <form class="auth-form" id="loginForm" action="verify_otp.php" method="POST">
                <div class="form-group">
                    <input type="hidden" name="email" value="<?php echo htmlspecialchars($email); ?>">
                    <label>Enter OTP:</label><br>
                    <input type="text" name="otp" class="form-input" required><br><br>
                </div>

                <button type="submit" href="check_otp.php" class="btn">Verify</button>
            </form>
